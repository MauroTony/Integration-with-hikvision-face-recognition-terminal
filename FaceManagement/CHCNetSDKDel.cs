...
namespace FaceManagement
{
    public class CHCNetSDKDel
    {
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[CHCNetSDKDel.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[CHCNetSDKDel.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[CHCNetSDKDel.MAX_DOOR_NUM_256 * CHCNetSDKDel.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[CHCNetSDKDel.ACS_CARD_NO_LEN];
                byCardPassword = new byte[CHCNetSDKDel.CARD_PASSWORD_LEN];
                byName = new byte[CHCNetSDKDel.NAME_LEN];
                byRes2 = new byte[3];               
                byLockCode = new byte[CHCNetSDKDel.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[CHCNetSDKDel.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[CHCNetSDKDel.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[CHCNetSDKDel.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[CHCNetSDKDel.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_COND
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDKDel.NET_DVR_TIME struStartTime;
            public CHCNetSDKDel.NET_DVR_TIME struEndTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;
            ...
            public byte byRes1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = CHCNetSDKDel.NET_SDK_MONITOR_ID_LEN)]
            public string szMonitorID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byEmployeeNo;
            ...
            public void Init()
            {
                ...
                byName = new byte[CHCNetSDKDel.NAME_LEN];
                byRes2 = new byte[2];
                byEmployeeNo=new byte[CHCNetSDKDel.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[140];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_CFG
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDKDel.NET_DVR_TIME struTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.MAX_NAMELEN)]
            public byte[] sNetUser;
            public CHCNetSDKDel.NET_DVR_IPADDR struRemoteHostAddr;
            public CHCNetSDKDel.NET_DVR_ACS_EVENT_DETAIL struAcsEventInfo;
        ...
        {
            public uint dwSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            ...
            public byte byType;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.MACADDR_LEN)]
            public byte[] byMACAddr;
            ...
            public byte[] byRe2;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKDel.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
            public byte[] byRes;
        }
        ...
        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_CaptureJPEGPicture(int lUserID, int lChannel,ref CHCNetSDKDel.NET_DVR_JPEGPARA lpJpegPara,IntPtr sPicFileName);
        #endregion
